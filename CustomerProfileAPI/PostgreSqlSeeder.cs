...
internal sealed class PostgreSqlSeeder
{
    ...
    private static async Task InsertSampleDataAsync(CustomerProfilesContext dbContext)
    {
        dbContext.CustomerProfiles.AddRange(
            new CustomerProfile { FirstName = "John", LastName = "Doe", Email = "john@doe.com", Address="Dallas,TX" },
            new CustomerProfile { FirstName = "Jane", LastName = "Doe", Email = "jane@doe.com", Address="Austin,TX"});
